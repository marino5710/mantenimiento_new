<h1>Ingreso de Tipos de Joya</h1>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitleId">
                    Ingresar Tipo de Joya
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form class="modal-body" id="formPrincipal" enctype="multipart/form-data">
                <input type="hidden" name="tipojoya_id" id="tipojoya_id">

                <div class="row mb-3">
                    <div class="col">
                        <label for="tipojoya_nombre_corto">Nombre del tipo de joya</label>
                        <input type="text" name="tipojoya_nombre_corto" id="tipojoya_nombre_corto" class="form-control" placeholder="Ej. Oro, Plata, Diamante">
                    </div>
                </div>

                <div class="row mb-3">
                    <div class="col">
                        <label for="tipojoya_descripcion">Descripción</label>
                        <textarea name="tipojoya_descripcion" id="tipojoya_descripcion" class="form-control" placeholder="Descripción del tipo de joya" rows="3"></textarea>
                    </div>
                </div>
            </form>
...
<!-- Script -->
<script src="<?= asset('build/js/tiposjoya/index.js') ?>"></script>